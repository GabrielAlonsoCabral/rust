...
use args::Args;
use image::{io::Reader, ImageFormat, DynamicImage, GenericImageView, imageops::FilterType::Triangle, ImageBuffer, Rgba};
...
fn get_smallest_dimmension(dim_1:(u32, u32),dim_2:(u32, u32))->(u32, u32){
...
fn standardise_size (image_1:DynamicImage, image_2:DynamicImage)->(DynamicImage, DynamicImage){
    let (width, height) = get_smallest_dimmension(image_1.dimensions(), image_2.dimensions());
...
fn combine_images(image_1:DynamicImage, image_2:DynamicImage)->Vec<u8>{
    ...
    let vec_2:Vec<u8> = image_1.to_rgba8().into_vec();
